...
class ProductSerializer(serializers.ModelSerializer):
    ...
    # Переопределяем to_representation для подстановки placeholder
    def to_representation(self, instance):
        # Берем стандартное представление
        data = super().to_representation(instance)

        # Если image_url пустое - ставим placeholder
        if not data.get('image_url'):
            data['image_url'] = '/static/assets/img/car_error.jpg'
